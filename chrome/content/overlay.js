...
var BiblioFox = {
  ...
  onMenuItemCommand: function() {
	var uri = new Uri(window.content.location);
//	newurl = uri.protocol() + "://" + uri.host() + ".gate1.inist.fr" + uri.path() +  uri.query() + uri.anchor();
	newurl = uri.protocol() + "://" + uri.host() + ".gate1.inist.fr" + uri.path();
	window.content.location = newurl;
  }
};

window.addEventListener("load", function(e) { BiblioFox.onLoad(e); }, false); 
